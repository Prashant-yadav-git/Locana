...
import { TopShops } from "@/components/shops/top-shops"
...
export function HomeScreen({ userRole }: HomeScreenProps) {
  const [activeTab, setActiveTab] = useState<"home" | "map" | "profile" | "dashboard" | "top-shops">("home")
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "map":
        return userRole === "customer" ? <MapView userRole={userRole} /> : <OwnerDashboard />
      case "profile":
